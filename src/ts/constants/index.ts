...
/**
 * JSON definition how to set icons
 */
...
/**
 * JSON definition how to set the default values of a BetterNiceSelect component
 */
...
/**
 * JSON definition which sets the language
 */
export type Localisation = Record<string,
    {
        formatSearch(): string;
        formatHelpForTagging(): string;
        formatAlertOptiongroups(): string;
...
/**
 * JSON definition how one searchitem does look like to work with
 */
...
/**
 * JSON definition how to export a default BetterNiceSelect component
 */
