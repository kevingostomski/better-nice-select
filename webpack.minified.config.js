...
const commonConfig = {
    ...
    plugins: [
        new MiniCssExtractPlugin({ filename: "css/better-nice-select.min.css" }),
...
const minifiedLocales = fileNames
...
module.exports = () => [...minifiedLocales, minifiedMain, minifiedAllLocales];
